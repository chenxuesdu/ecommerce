...
public class ELB {
	 ...
	 *
	 * This class is meant as a starting point for your console-based
	 * application that makes one or more calls to the AWS services supported by
	 * the Java SDK, such as EC2, SimpleDB, and S3.
	 *
	...
	public static void main(String[] args) {
		...
		List<SecurityGroup> securityGroups = ec2Instance
				.getSecurityGroupId(elbClients.elbConfig.getSecurityGroupName());
		...
		String elbState = elbClients.createELB(elbClients.elbConfig.getName(),
