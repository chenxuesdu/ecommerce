...
public class ELBv1Clients extends AWSClients {
	...
	public ELBv1Clients(String configFilePath) {
		...
		try {
			elbConfig = mapper.readValue(new File(configFilePath),
					ELBConfig.class);
			System.out.println(ReflectionToStringBuilder.toString(elbConfig,
	 ...
	 */
	public void createELB(String elbName, List<String> securityGroups,
			List<String> ec2InstanceSubnetIds) {
		CreateLoadBalancerRequest request = new CreateLoadBalancerRequest();
		request.setLoadBalancerName(elbName);
		List<Listener> listeners = new ArrayList<Listener>();
		listeners.add(new Listener(elbConfig.getelbProtocol(), elbConfig
				.getelbPort(), elbConfig.getInstancePort()));
		...
		// CreateTargetGroupRequest targetGroupRequest = new
		...
		CreateLoadBalancerResult response = AWSELBClient
	...
	/*
	 * http://docs.aws.amazon.com/AWSJavaSDK/latest/javadoc/com/amazonaws/services
	 * /elasticloadbalancing/model/LoadBalancerAttributes.html
	 */
	...
	public void enableCrossZoneLoadBalancing() {
		...
		ModifyLoadBalancerAttributesResult response = AWSELBClient
	...
	/*
	 * http://docs.aws.amazon.com/cli/latest/reference/elb/apply-security-groups-
	 * to-load-balancer.html
	 */
	public void applySecurityGroupELB(String ELBName,
			List<String> securityGroups) {
		ApplySecurityGroupsToLoadBalancerRequest request = new ApplySecurityGroupsToLoadBalancerRequest();
		request.setLoadBalancerName(ELBName);
		request.setSecurityGroups(securityGroups);

		ApplySecurityGroupsToLoadBalancerResult response = AWSELBClient
	...
	/*
	 * http://docs.aws.amazon.com/cli/latest/reference/elb/create-load-balancer-
	 * listeners.html
	 */
	public void createELBListener(String elbProtocol, String instanceProtocol,
			Integer instancePort, Integer elbPort) {
		...
		CreateLoadBalancerListenersResult response = AWSELBClient
	...
	public void deleteELB(String ELBName) {
		...
		DeleteLoadBalancerResult response = AWSELBClient
	...
	/*
	 * http://docs.aws.amazon.com/cli/latest/reference/elb/describe-load-balancers
	 * .html
	 */
	public void listELB() {
		DescribeLoadBalancersResult response = AWSELBClient
				.describeLoadBalancers();

		List<LoadBalancerDescription> ELBDescriptionList = response
	...
	private void printELBDescription(
			List<LoadBalancerDescription> ELBDescriptionList) {
		for (LoadBalancerDescription ELBDescription : ELBDescriptionList) {
			...
			System.out.println("\tTarget: "
					+ ELBDescription.getHealthCheck().getTarget());
			System.out.println("\tInterval: "
					+ ELBDescription.getHealthCheck().getInterval());
			System.out.println("\tHealthyThreshold: "
					+ ELBDescription.getHealthCheck().getHealthyThreshold());
			System.out.println("\tTimeout: "
					+ ELBDescription.getHealthCheck().getTimeout());
			System.out.println("\tUnhealthyThreshold: "
					+ ELBDescription.getHealthCheck().getUnhealthyThreshold());
			...
			for (ListenerDescription listenerDescription : ELBDescription
					.getListenerDescriptions()) {
				System.out.println("\tProtocol: "
						+ listenerDescription.getListener().getProtocol());
				System.out.println("\tInstanceProtocol: "
						+ listenerDescription.getListener()
								.getInstanceProtocol());
				System.out.println("\tLoadBalancerPort: "
						+ listenerDescription.getListener()
								.getLoadBalancerPort());
				System.out.println("\tInstancePort: "
						+ listenerDescription.getListener().getInstancePort());
			}
	...
	/*
	 * http://docs.aws.amazon.com/AWSJavaSDK/latest/javadoc/com/amazonaws/services
	 * /elasticloadbalancing/model/HealthCheck.html
	 * 
	 * http://docs.aws.amazon.com/cli/latest/reference/elb/configure-health-check
	 * .html
	 */
	public void createOrUpdateHealthCheck(String ELBName) {
		...
		ConfigureHealthCheckResult response = AWSELBClient
	...
	/*
	 * http://docs.aws.amazon.com/cli/latest/reference/elb/describe-instance-health
	 * .html
	 */
	public Map<String, String> getInstanceHealth(String ELBName,
		...
		DescribeInstanceHealthResult response = AWSELBClient
	...
	/*
	 * http://docs.aws.amazon.com/cli/latest/reference/elb/delete-load-balancer-
	 * listeners.html
	 */
	public void deleteELBListener(String ELBName, Integer ELBPort) {
		...
		DeleteLoadBalancerListenersResult response = AWSELBClient
	...
	/*
	 * http://docs.aws.amazon.com/cli/latest/reference/elb/register-instances-with
	 * -load-balancer.html
	 */
	public void registerInstancesToELB(String ELBName, List<String> instanceIds) {
		...
		RegisterInstancesWithLoadBalancerResult response = AWSELBClient
				.registerInstancesWithLoadBalancer(request);

		System.out.println("RegisterInstancesWithLoadBalancerResult: "
				+ response);
	}

	/*
	 * http://docs.aws.amazon.com/cli/latest/reference/elb/deregister-instances-from
	 * -load-balancer.html
	 */
	public void deregisterInstancesFromELB(String ELBName,
			List<String> instanceIds) {
		DeregisterInstancesFromLoadBalancerRequest request = new DeregisterInstancesFromLoadBalancerRequest();
		request.setLoadBalancerName(ELBName);
		request.setInstances(getELBInstanceList(instanceIds));

		DeregisterInstancesFromLoadBalancerResult response = AWSELBClient
				.deregisterInstancesFromLoadBalancer(request);

		System.out.println("DeregisterInstancesFromLoadBalancerResult: "
				+ response);
	}
